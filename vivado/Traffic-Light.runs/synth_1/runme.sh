...
HD_PWD='C:/Users/Trung/Desktop/Crossroad-Traffic-Light/vivado/Traffic-Light.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_module_tb.tcl
